...
def hyper_tuner_for_times(aug, tune, model_path, times):
...
def load_existed_model(model_path='E:/Integrated_package/DvsGes/dvs_SAVE_new_2/cp.keras', tune=True, aug=True):
    import tensorflow as tf
