# graduate_thesis
For ResNet-LSTM model, try six_channel_main.py. change the argument of fet_mode in function hyper_tuner to False.

For two-reservoir model, try six_channel_main.py. change the argument of fet_mode in function hyper_tuner to True.
